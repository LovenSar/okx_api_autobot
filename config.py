...
# 后端实时数据刷新线程间隔（秒）
BACKEND_REALTIME_UPDATE_INTERVAL_SECONDS = _get_float("REALTIME_UPDATE_INTERVAL_SEC", 5)
...
# 批量下单是否使用市价单（1=市价，0=限价）；默认市价
BATCH_USE_MARKET = _get_int("BATCH_USE_MARKET", 1)
